...
| Android | [`EasyCodex.Mobile.0.1.1.apk`](https://github.com/Ryan-Laws/easycodex/releases/download/v0.1.1/EasyCodex.Mobile.0.1.1.apk) | Android 手機應用 |
...
4. 在 Android 手機上安裝 `EasyCodex.Mobile.0.1.1.apk`。

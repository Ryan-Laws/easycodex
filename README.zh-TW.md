...
| 平台 | 下載 | 用途 |
| --- | --- | --- |
| Windows | [`EasyCodex.Relay.Setup.0.1.0-x64.exe`](https://github.com/Ryan-Laws/easycodex/releases/download/v0.1.0/EasyCodex.Relay.Setup.0.1.0-x64.exe) | 推薦的 Windows 桌面端中繼安裝包 |
| Windows | [`EasyCodex.Relay.Portable.0.1.0-x64.exe`](https://github.com/Ryan-Laws/easycodex/releases/download/v0.1.0/EasyCodex.Relay.Portable.0.1.0-x64.exe) | 免安裝可攜版 Windows 中繼 |
...
| macOS Apple Silicon | [`EasyCodex.Relay.0.1.0.mac-arm64.dmg`](https://github.com/Ryan-Laws/easycodex/releases/download/v0.1.0/EasyCodex.Relay.0.1.0.mac-arm64.dmg) | Apple Silicon 桌面端中繼 |
| macOS Intel | [`EasyCodex.Relay.0.1.0.mac-x64.dmg`](https://github.com/Ryan-Laws/easycodex/releases/download/v0.1.0/EasyCodex.Relay.0.1.0.mac-x64.dmg) | Intel 桌面端中繼 |
| Linux | [`EasyCodex.Relay.0.1.0.linux-x64.AppImage`](https://github.com/Ryan-Laws/easycodex/releases/download/v0.1.0/EasyCodex.Relay.0.1.0.linux-x64.AppImage) | 免安裝 Linux 中繼 |
| Linux | [`EasyCodex.Relay.0.1.0.linux-x64.deb`](https://github.com/Ryan-Laws/easycodex/releases/download/v0.1.0/EasyCodex.Relay.0.1.0.linux-x64.deb) | Debian/Ubuntu 安裝包 |

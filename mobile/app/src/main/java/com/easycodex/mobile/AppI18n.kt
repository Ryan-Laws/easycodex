...
private val ChineseAppStrings = AppStrings(
    ...
    easyCodexAgents = "EasyCodex agents",
    home = "总首页",
    noAgents = "还没有智能体",
    ...
    flex = "弹性",
    serviceDefault = "标准",
    fastDescription = "使用当前模型提供的快速档。",
    flexDescription = "通常成本更低，但响应可能更慢或暂时不可用。",
    defaultSpeedDescription = "使用官方默认速度和价格。",
...
private val EnglishAppStrings = ChineseAppStrings.copy(
    ...
    noBody = "No body",
    app = "App",
    appSubtitle = "Version, appearance, and local data.",
    version = "Version",
    ...
    fast = "Fast",
    flex = "Flex",
    serviceDefault = "Standard",
    fastDescription = "Use the current model's fast tier.",
    flexDescription = "Usually cheaper, but may be slower or temporarily unavailable.",
    defaultSpeedDescription = "Use the official default speed and pricing.",
